...
export const STRINGS = {
  ...
  // Staff account creation (P11) — Admin creates TEACHER/ADMIN accounts only.
  staffCreateHeading: "เพิ่มบัญชีบุคลากร",
  staffCreateIntro: "สร้างบัญชีครูหรือผู้ดูแลระบบ — ระบบจะสร้างรหัสผ่านชั่วคราวให้ ผู้ใช้ต้องตั้งรหัสผ่านใหม่เมื่อเข้าสู่ระบบครั้งแรก",
  staffCreateFullNameLabel: "ชื่อ-นามสกุล (ไม่บังคับ)",
  staffCreateUsernameLabel: "ชื่อผู้ใช้",
  staffCreateUsernameHelp: "ตัวอักษรภาษาอังกฤษ ตัวเลข จุด ขีดกลาง หรือขีดล่าง 3-32 ตัวอักษร",
  staffCreateEmailLabel: "อีเมลมหาวิทยาลัย (ไม่บังคับ)",
  staffCreateEmailHelp: "หากกรอก ต้องเป็นอีเมล @rmutsb.ac.th เท่านั้น",
  staffCreateRoleLabel: "ประเภทบัญชี",
  staffCreateRoleTeacher: "ครู",
  staffCreateRoleAdmin: "ผู้ดูแลระบบ",
  staffCreateSubmit: "สร้างบัญชี",
  staffCreateSubmitting: "กำลังสร้างบัญชี...",
  staffCreateResultHeading: "สร้างบัญชีสำเร็จ",
  staffCreateResultUsernameLabel: "ชื่อผู้ใช้: ",
  staffCreateResultRoleLabel: "ประเภทบัญชี: ",
  staffCreateResultPasswordLabel: "รหัสผ่านชั่วคราว: ",
  staffCreateResultExpiryLabel: (date) => `หมดอายุ: ${date}`,
  staffCreateCopyNowWarning: "คัดลอกรหัสชั่วคราวนี้ตอนนี้ ระบบจะไม่แสดงรหัสนี้อีก",
  staffCreateForcedChangeExplanation: "เมื่อเข้าสู่ระบบครั้งแรก ผู้ใช้จะต้องตั้งรหัสผ่านใหม่ก่อนใช้งานระบบ",
  staffCreateCopyButton: "คัดลอกรหัสผ่าน",
  staffCreateCopySuccess: "คัดลอกแล้ว ✓",
  staffErrInvalidRole: "กรุณาเลือกประเภทบัญชีที่ถูกต้อง",
  staffErrInvalidUsername: "ชื่อผู้ใช้ต้องเป็นตัวอักษรภาษาอังกฤษ/ตัวเลข 3-32 ตัวอักษร (ใช้ . _ - ได้)",
  staffErrUsernameTaken: "มีผู้ใช้ชื่อนี้อยู่แล้ว กรุณาเลือกชื่อผู้ใช้อื่น",
  staffErrInvalidEmailDomain: "อีเมลต้องเป็น @rmutsb.ac.th เท่านั้น",
  ...
  teacherLoadError: "ไม่สามารถโหลดข้อมูลห้องเรียนได้ในขณะนี้",
  teacherTotalStudents: "นักเรียนทั้งหมด",
  teacherStarted: "เริ่มเรียนแล้ว",
  teacherCompleted: "เรียนจบแล้ว",
  teacherAverageProgress: "ความคืบหน้าเฉลี่ย",
  teacherNeedingAttention: "นักเรียนที่ยังไม่เริ่มเรียน",
  teacherRecentActivity: "กิจกรรมล่าสุดของนักเรียน",
  teacherRosterHeading: "รายชื่อนักเรียน",
  teacherSearchPlaceholder: "ค้นหาด้วยชื่อ รหัสนักศึกษา หรือชื่อผู้ใช้",
  teacherFilterLabel: "กรองตามสถานะ",
  teacherFilterAll: "ทั้งหมด",
  teacherFilterNotStarted: "ยังไม่เริ่ม",
  teacherFilterInProgress: "กำลังเรียน",
  teacherFilterCompleted: "เรียนจบแล้ว",
  teacherExportCsv: "ส่งออกเป็น CSV",
  teacherColName: "ชื่อ-นามสกุล",
  teacherColStudentId: "รหัสนักศึกษา",
  teacherColProgress: "ความคืบหน้า",
  teacherColQuizzes: "แบบทดสอบ",
  teacherColChallenges: "แบบฝึกท้าทาย",
  teacherColStatus: "สถานะ",
  teacherColCertificate: "ใบประกาศนียบัตร",
  teacherColAction: "ดูรายละเอียด",
  teacherViewDetail: "ดูรายละเอียด",
  teacherRosterEmpty: "ไม่พบนักเรียนที่ตรงกับเงื่อนไขนี้",
  teacherCertIssued: "ออกแล้ว",
  teacherCertNotIssued: "ยังไม่ออก",
  teacherBack: "← กลับไปที่รายชื่อนักเรียน",
  teacherOverallProgress: "ความคืบหน้ารวม",
  teacherCertIssuedOn: (date) => `ออกใบประกาศนียบัตรแล้วเมื่อ ${date}`,
  teacherQuizNotAttempted: "ยังไม่ได้ทำแบบทดสอบ",
};
